...
// (in-package server_client_cpp.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'server_client_cpp/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'server_client_cpp/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'server_client_cpp/AddTwoInts'; }
};
